...
const MyComplaints = () => {
  ...
  useEffect(() => {
    const replied = complaints.filter(
      (c) => c.adminReply && c.status === "resolved",
    );

    if (replied.length > 0) {
      toast.success(`🔔 ${replied.length} complaint(s) have new admin updates`);
    }
  }, [complaints]);
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            <p
              style={{ color: "#6b7280", fontSize: "14px", margin: "4px 0 0" }}
            >
        ...
        >
          {[
            ...
            {
              label: "Reviewing",
              value: complaints.filter((c) => c.status === "reviewing").length,
              color: "#60a5fa",
            },
            {
              label: "Resolved",
            ...
            >
              <div
                style={{ fontSize: "28px", fontWeight: 700, color: s2.color }}
              >
                {s2.value}
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <span
                      style={{
                        background: priorityColors[c.priority] + "33",
