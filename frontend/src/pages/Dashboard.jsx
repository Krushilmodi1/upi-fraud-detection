...
const Dashboard = () => {
  ...
  const c = {
    ...
    tierBadge: (tier) => {
      const cfg = {
        High: ["var(--danger-light)", "var(--danger)"],
        Medium: ["var(--warning-light)", "var(--warning)"],
        Low: ["var(--success-light)", "var(--success)"],
      };
      return {
        padding: "2px 10px",
        borderRadius: "20px",
      ...
      <div className="fade" style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <div>
                ...
                >
                  {fraudCount} Fraudulent Transaction{fraudCount > 1 ? "s" : ""}{" "}
                  Detected
                </div>
                <div
                  style={{ fontSize: "13px", color: "var(--text-secondary)" }}
                >
                  Take action immediately to protect your account
                </div>
              </div>
            </div>
            <Link
        ...
        >
          {[
            ...
            },
            {
              ...
              value: fraudCount,
              color: "var(--danger)",
              sub: `₹${fraudAmount.toLocaleString("en-IN")} at risk`,
              icon: "🚨",
            },
            {
        ...
        >
          ...
          >
            ...
            >
              <div>✅ No suspicious UPI IDs detected</div>

              <div>🛡️ Security Score: {secScore}/100</div>

              <div>⚠️ Avoid sending money to unknown users</div>
            </div>
          </div>
          <div style={c.card}>
            <div
            ...
            >
              {[
                ["#22c55e", "Safe", safeCount],
                ["#ef4444", "Fraud", fraudCount],
              ].map(([col, label, val]) => (
                <div
                  key={label}
        ...
        >
          ...
          <p>
            Lost money due to fraud? Immediately contact cybercrime helpline.
          </p>
        ...
        >
          ...
          >
            <div>🔴 Fraud Cases: {fraudCount}</div>

            <div>🟢 Safe Transactions: {safeCount}</div>

            <div>💰 Amount At Risk: ₹{fraudAmount.toLocaleString("en-IN")}</div>
          </div>
        </div>
        {/* Transaction History */}
        <div style={c.card}>
              ...
              {filtered.map((t, i) => (
                <div key={i}>
                  ...
                  >
                    ...
                    >
                      <span style={c.badge(t.isFraud)}>
                        {t.isFraud ? "🚨 Fraud" : "✅ Safe"}
                      </span>
                      <span style={c.tierBadge(t.riskTier)}>
                        {t.riskTier} Risk
                      </span>
                    ...
                    >
                      <div
                        style={{
                          ...
                          gridTemplateColumns: "repeat(3, 1fr)",
                          gap: "10px",
                          marginBottom: t.isFraud ? "12px" : "0",
                        }}
                      >
                        {[
                          {
                            label: "Fraud Probability",
                            value: `${(t.fraudProbability * 100).toFixed(1)}%`,
                          },
        ...
        >
          ...
          <div style={{ fontSize: "13px", color: "var(--text-secondary)" }}>
            ...
            Always verify the receiver name shown in your UPI app before
            confirming payment. Send ₹1 first to unknown UPI IDs.
            <Link
              to="/assistance"
              style={{
                color: "var(--accent)",
